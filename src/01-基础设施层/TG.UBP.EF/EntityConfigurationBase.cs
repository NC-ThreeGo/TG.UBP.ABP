...
namespace TG.UBP.EF
{
    ...
    /// <typeparam name="TPrimaryKey">动态主键类型</typeparam>
    public abstract class EntityConfigurationBase<TEntity, TPrimaryKey> : EntityTypeConfiguration<TEntity>, IEntityMapper
